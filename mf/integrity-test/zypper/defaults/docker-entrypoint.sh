...
zypper -n install --allow-unsigned-rpm /migasfree-client/dist/migasfree-client-*.noarch.rpm
cd -
...
zypper -n install --allow-unsigned-rpm /migasfree-sdk/dist/migasfree-sdk-*.noarch.rpm
cd -
...
# =========================
zypper -n remove migasfree-client
zypper -n install migasfree-client
migasfree -u
